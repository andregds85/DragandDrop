...
$(document).ready(function(){ 
	...
	$(function() {
		$(".list-group").sortable({ opacity: 0.6, cursor: 'move', update: function() {
...
<div>
    ...
    <ul v-sortable class="list-group">
            ...
            while($row = $select->fetch_assoc()){
                echo '<li class="list-group-item" id="recordsArray_'.$row['id'].'"><div class="dragdrop"><strong><span role="textbox" contenteditable>'.$row['title'].'</span></strong></div></li>';
            }
